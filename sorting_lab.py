...
def selection_sort(my_list):
    for current_position in range(len(my_list)):
        ...
        for scan_position in range(current_position + 1, len(my_list)):
            if my_list[scan_position][1] < my_list[minimum_position][1]:
...
'''
My failed efforts with insertion sort. 

def insertion_sort(my_list):
    for key_pos in range(0, len(my_list)):
